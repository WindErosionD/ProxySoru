...
def setOpts(parser):
	...
	parser.add_option(
		...
		dest="test_method",
		default="stasync",
		help="Select test method in [speedtestnet, fast, socket, stasync]. Default: stasync."
		)
	parser.add_option(
		"-M","--mode",
		action="store",
	...
	parser.add_option(
		...
		dest="sort_method",
		default="",
		help="Select sort method in [speed,rspeed,ping,rping]; default: speed (avg download, high to low)."
		)
	parser.add_option(
		"-i","--import",
		action="store",
	...
	parser.add_option(
		...
		dest="topology",
		default=False,
		help="Enable topology analysis export."
		)
	parser.add_option(
		"--paolu",
		action="store_true",
